...
const toBackEndReducer = (state = {
    selectedPlaylist: "", // playlistId (playlist has been created)
    data2save: [] // with the selected playlist below
}, action) => {
    switch (action.type) {
...
export default toBackEndReducer